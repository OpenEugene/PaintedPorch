[Home](Home.md) / Docs <!-- wikidown:breadcrumb -->

# Docs

Documentation for building the Painted Porch's column project.

## Columns

- [Columns](Columns.md) — the column layer stack overview
- [Bill of Materials](Columns/Bill of Materials.md)
- [Assembly Instructions](Columns/Assembly Instructions.md)
